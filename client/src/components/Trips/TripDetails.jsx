    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="space-y-6">
        ...
        {activeTab === 'ai-tips' && (
          <div className="space-y-6">
            {[
              { title: 'Packing Recommendations', content: trip.aiSuggestions.packingRecommendations, color: 'blue' },
              { title: 'Travel Tips', content: trip.aiSuggestions.travelTips, color: 'green' },
              { title: 'Local Attractions', content: trip.aiSuggestions.localAttractions, color: 'purple' }
            ].map((suggestion, index) => (
              <div key={index} className={`bg-${suggestion.color}-50 rounded-lg border border-${suggestion.color}-200 p-6`}>
